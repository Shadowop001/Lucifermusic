...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i> @LUCIFER_VC Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="𝐋𝐔𝐂𝐈𝐅𝐄𝐑 𝐌𝐔𝐒𝐈𝐂▶️ **Playing** here the song requested by {} ".format(
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        user.first_name =  "LUCIFER_OP_MUSIC_BOT"
    usar = user
    wew = usar.id
    try:
        #chatdetails = await USER.get_chat(chid)
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>@LUCIFER_VC userbot joined your chat</b>",
                              )
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        appendable = [s_name, r_by, loc]
        qeue.append(appendable)
        await res.edit_text(f"𝐋𝐔𝐂𝐈𝐅𝐄𝐑 𝐌𝐔𝐒𝐈𝐂=#️⃣ Queued at position {position}")
    else:
        await res.edit_text("𝐋𝐔𝐂𝐈𝐅𝐄𝐑 𝐌𝐔𝐒𝐈𝐂=▶️ Playing.....")
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> @LUCIFER_VC helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    requested_by = message_.from_user.first_name
    chat_id=message_.chat.id
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"𝐋𝐔𝐂𝐈𝐅𝐄𝐑 𝐌𝐔𝐒𝐈𝐂=#️⃣ Queued at position {position}",
